...
var app=new Vue({
    ...
    methods:{
        ...
        searchList:function (curPage) {
            axios.post('/goods/list.shtml?pageNum='+curPage,this.searchEntity).then(function (response) {
                //获取数据
        ...
        //修改
        updateById:function () {
            axios.post('/goods/modify.shtml',this.entity).then(function (response) {
                if(response.data.success){
                    //清空原有数据
                    app.entity={};
                    //刷新页面
        ...
        //根据ID查询
        getById:function (id) {
            axios.get('/goods/one/'+id+'.shtml').then(function (response) {
